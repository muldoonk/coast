...
import { PassioEntry, passioCollectionName, mongoUrl, routesCollectionName, RoutesEntry } from './mongo_schemas.js';
...
const main = async () => {
    ...
    const routesCollection = model(routesCollectionName, RoutesEntry, routesCollectionName)
    ...
    app.get('/buses', async (req, res) => {
      const result = await routesCollection.find().limit(50);
      res.send(result);
    });
