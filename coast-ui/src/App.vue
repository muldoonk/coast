...
<template>
  <main>
    <div class="custom-shape-divider-top-1723835157">
...
.custom-shape-divider-top-1723835157 {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
...
.custom-shape-divider-top-1723835157 svg {
    position: relative;
    display: block;
...
.custom-shape-divider-top-1723835157 .shape-fill {
    fill: #04E762;
}
...
.container {
  padding: 115px 30px; // account for wave and paralellogram
